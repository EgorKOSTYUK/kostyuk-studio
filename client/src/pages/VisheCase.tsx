      ...
      <main>
        ...
        <section className="theme-section border-y border-black/8 bg-white/55">
          <div className="container py-24 md:py-32">
            ...
            <div className="mt-14 rounded-[30px] bg-[#101214] p-7 text-white md:p-10">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-white/42">Что подтверждает этот проект</p>
